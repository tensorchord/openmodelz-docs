...
<Callout type="info" emoji="⚠️">
  This requires the Nvidia Toolkit to be installed on the host machine before you run `mdz server start`. Check out the [Nvidia Toolkit installation guide](https://docs.nvidia.com/datacenter/cloud-native/container-toolkit/install-guide.html#docker) for more information.
</Callout>
