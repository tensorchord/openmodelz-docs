...
- Image name: [`modelzai/streamlit-background-remover`](https://hub.docker.com/repository/docker/modelzai/streamlit-background-remover)
- Repository: [tensorchord/modelz-background-remover](https://github.com/tensorchord/modelz-background-remover)
- Dockerfile: [Dockerfile](https://github.com/tensorchord/modelz-background-remover/blob/main/Dockerfile)
