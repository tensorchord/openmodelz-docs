...
- Image name: [`modelzai/llm-chatglm-6b`](https://hub.docker.com/repository/docker/modelzai/llm-chatglm-6b)
- Repository: [tensorchord/modelz-llm](https://github.com/tensorchord/modelz-llm)
- Dockerfile: [Dockerfile](https://github.com/tensorchord/modelz-llm/blob/main/images/chatglm-6b/Dockerfile)
