# OpenAI API compatible BloomZ 560M

## Image Details

- Image name: [`modelzai/llm-bloomz-560m`](https://hub.docker.com/repository/docker/modelzai/llm-bloomz-560m/)
- Repository: [tensorchord/modelz-llm](https://github.com/tensorchord/modelz-llm)
- Dockerfile: [Dockerfile](https://github.com/tensorchord/modelz-llm/blob/main/images/bloomz-560m/Dockerfile)
